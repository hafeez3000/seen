...
$this->title[] = Yii::t('Oauth/Application', 'Update');
$this->title[] = Yii::t('Oauth/Application', 'Application {name}', ['name' => $model->name]);
...
<h1><?php echo Yii::t('Oauth/Application', 'Update application {name}', ['name' => $model->name]); ?></h1>
	...
	<div class="col-md-6">
		<?php $form = ActiveForm::begin([
			...
			<div class="form-group">
				<?php echo Html::submitButton(Yii::t('Oauth/Application', 'Update application'), ['class' => 'btn btn-primary', 'name' => 'update-button']) ?>
			</div>
