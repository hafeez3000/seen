...
class Movie extends ActiveRecord
{
	...
	public function getPosterSmallAttribute()
	{
	...
	/**
	 * Get the src attribute for an image tag for a large backdrop image.
	 *
	 * @return string
	 */
	public function getBackdropLargeAttribute()
	{
		if (!empty($this->poster_path))
	...
	/**
	 * Get the url for an image tag for a large backdrop image.
	 *
	 * @return string
	 */
	public function getBackdropLargeUrl()
	{
		if (!empty($this->backdrop_path))
			...
			return 'https://placehold.it/1280x500/eee/555&text=' . urlencode(Yii::t('Movie', 'No Image'));
	}
}
