...
<div id="admin-dashboard" class="row">
	...
	<?php if (Yii::$app->user->can('admin')): ?>
		<div class="col-xs-3 col-sm-2 col-md-2 col-lg-1">
			<a href="<?php echo Url::toRoute('missing/index'); ?>" title="<?php echo Yii::t('Admin', 'Missing Episodes'); ?>">
				<img src="<?php echo Yii::$app->request->baseUrl ?>/images/admin/missing.png" alt="<?php echo Yii::t('Admin', 'Missing Episodes'); ?>">
			</a>
		</div>
	<?php endif; ?>
</div>
